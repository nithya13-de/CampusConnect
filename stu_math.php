...
<div class="container">
    ...
    <div class="box relative">
        <h2>Treasure Hunt</h2>
        <p>This is a thrilling treasure hunt event where participants solve clues to find hidden treasures!</p>
        <div class="status">Status: Past</div>
        <div class="view">
            <button onclick="location.href='treasure.html'">View</button>
        </div>
    </div>
</div>
