...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $deleteSql = "DELETE FROM rythmic WHERE id = $deleteId";
...
$sql = "SELECT * FROM rythmic ORDER BY created_at DESC";
...
<div class="container">
    ...
    <div class="box relative">
        ...
        <div class="view">
            <button onclick="location.href='dancing-gala.html'">View</button>
        </div>
    </div>
    <div class="box relative">
        <h2>Dance Fiesta</h2>
        <div class="status">Status: Past</div>
        <div class="view">
            <button onclick="location.href='dance-fiesta.html'">View</button>
        </div>
    </div>
    <div class="box relative">
        <h2>Flashmob</h2>
        <div class="status">Status: Past</div>
        <div class="view">
            <button onclick="location.href='flashmob.html'">View</button>
        </div>
    </div>
</div>
