...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $deleteSql = "DELETE FROM sports WHERE id = $deleteId";
...
$sql = "SELECT * FROM sports ORDER BY created_at DESC";
...
<div class="container">
    ...
    <div class="box relative">
        ...
        <div class="view">
            <button onclick="location.href='sports-description.html'">View</button>
        </div>
    </div>
</div>
