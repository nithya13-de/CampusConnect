...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $deleteSql = "DELETE FROM rmf WHERE id = $deleteId";
...
$sql = "SELECT * FROM rmf ORDER BY created_at DESC";
...
<div class="container">
    ...
    <div class="box relative">
        <h2>Rangoli(Holi) Event</h2>
        <div class="status">Status: Past</div>
        <div class="view">
            <button onclick="location.href='page1.html'">View</button>
        </div>
    </div>
    <div class="box relative">
        <h2>Committee Kurrollu Movie Promotion</h2>
        <div class="status">Status: Past</div>
        <div class="view">
            <button onclick="location.href='page2.html'">View</button>
        </div>
    </div>
</div>
